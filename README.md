...
### 2026-09-03 (3) — แถบชื่อโปรเจคไม่ขึ้นตอนโหลดครั้งแรก

เข้าหน้าโปรเจคครั้งแรกแบบยังไม่มี cache แล้วชื่อโปรเจคใหญ่กับแถบชื่อโปรเจคด้านล่างไม่ขึ้น ต้องเลื่อน
ไปหน้าอื่นแล้วกลับมาถึงจะโผล่ — สาเหตุคือไฟล์ 3D (iPhone 5.7MB · MacBook 9.3MB · บัตร 2.3MB
และ HDR อีกราว 2MB) โหลดแบบ suspend โดยไม่มีขอบเขตของตัวเอง React จึงกลั้นการ commit ทั้งหน้า
ไว้จนไฟล์โหลดเสร็จ: scroll ไปอยู่ที่โปรเจคแรกแล้วจริง แต่จอยังวาดหน้าเดิมค้าง แก้โดยใส่ Suspense
boundary ให้โมเดลอุปกรณ์และบัตรห้อยคอแยกกัน — วัดบนบิลด์จริงที่จำลองเน็ต 700kbps + cache ว่าง
จาก 23 วินาที (หรือไม่ขึ้นเลย) เหลือ 402ms
